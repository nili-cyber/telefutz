...
const sample = [
  { name: "Ridge Line", description: "A crew chases a wildfire across three states.", genre: "Drama", releaseYear: 2024, posterUrl: "/posters/ridge-line.jpg", videoId: "ridge-line-master" },
  { name: "Signal Loss", description: "A radio operator picks up a transmission that shouldn't exist.", genre: "Sci-Fi", releaseYear: 2023, posterUrl: "/posters/signal-loss.jpg", videoId: "signal-loss-master" },
